copy /B sh-pro.00 + sh-pro.01 + sh-pro.02 + sh-pro.03 + sh-pro.04 + sh-pro.05 satans_hollow_cpu.bin
make_vhdl_prom satans_hollow_cpu.bin satans_hollow_cpu.vhd

copy /B sh-snd.01 + sh-snd.02 +sh-snd.03 satans_hollow_sound_cpu.bin
...
rem make_vhdl_prom sh-fg.00 satans_hollow_sp_bits_1.vhd
rem make_vhdl_prom sh-fg.01 satans_hollow_sp_bits_2.vhd
rem make_vhdl_prom sh-fg.02 satans_hollow_sp_bits_3.vhd
rem make_vhdl_prom sh-fg.03 satans_hollow_sp_bits_4.vhd

copy /B sh-fg.00 + sh-fg.01 + sh-fg.02 + sh-fg.03 satans_hollow_sp_bits.bin
