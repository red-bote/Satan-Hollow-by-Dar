...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports ps2_dat];#Sch name = JB1
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports ps2_clk];#Sch name = JB3
